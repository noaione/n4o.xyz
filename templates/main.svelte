...
<main>
    <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
        ...
        <div id="main" class="col-sm-6">
			...
			<h3 class="bolder"><a class="linkify" href="https://ihateani.me">ihateani.me</a></h3>
			<hr />
            <h4 class="bolder">
                <span class="linkify" on:click={toggleKeys}>gpg keys</span>
            </h4>
        ...
        <div id="keys-set" class="col-sm-6">
            <h4 class="bolder"><span class="linkify" on:click={toggleKeys}>&lt; go back</span></h4>
            <hr />
            {#each keys as {is_default, name, path}, i}
                <h3 class="bolder">
                    <a class="linkify" href="/keys/{path}">{name}</a>
                    {#if is_default}
